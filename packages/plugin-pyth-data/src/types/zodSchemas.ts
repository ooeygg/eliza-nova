...
const ParsedPriceUpdate = z
  ...
  .passthrough()
const PriceUpdate = z
  .object({ binary: BinaryUpdate, parsed: z.array(ParsedPriceUpdate).nullish() })
  .passthrough()
...
const LatestPublisherStakeCapsUpdateDataResponse = z
  .object({ binary: BinaryUpdate, parsed: z.array(ParsedPublisherStakeCapsUpdate).nullish() })
  .passthrough()
...
const TwapsResponse = z
  .object({ binary: BinaryUpdate, parsed: z.array(ParsedPriceFeedTwap).nullish() })
  .passthrough()
