    ...
    useEffect(() => {
        ...
        const updateCursorStyle = (e: MouseEvent) => {
            ...
            if (isClickable) {
                ...
                trail.style.borderColor = 'rgba(156, 39, 176, 0.8)';
                glow.style.background = 'radial-gradient(circle, rgba(156, 39, 176, 0.3) 0%, rgba(156, 39, 176, 0.2) 40%, rgba(156, 39, 176, 0) 70%)';
            } else {
                trail.style.width = '24px';
                trail.style.height = '24px';
                trail.style.opacity = '0.5';
                trail.style.borderColor = 'rgba(255, 255, 255, 0.5)';
                glow.style.background = 'radial-gradient(circle, rgba(156, 39, 176, 0.15) 0%, rgba(156, 39, 176, 0.1) 40%, rgba(156, 39, 176, 0) 70%)';
            }
        };
